    ...
    <div >
      ...
      <main className="h-[85vh] w-[70%] m-auto">
        ...
        <div className="w-[100%] p-2 h-[10%] gap-2 m-auto mb-4 border border-gray-400 flex items-center justify-center bg-transparent">
          <div className="w-[50%]">
            <input type="text" placeholder="Pesquisar produto" className="bg-white w-[100%] outline-none p-2 border border-gray-400" />
          </div>
            ...
            {Produtos.map(item => (
              ...
              <tbody className="tbody-estoque" >
                <tr key={item.cod}>
                  <td >{item.cod}</td>
                  <td >{item.desc}</td>
                  <td style={item.saldo > 0 ? { color: "black" } : { color: "red" }} className='bg-transparent text-xl'>{item.saldo}</td>
                  <td >{item.valorUni}</td>
                  <td >{item.cat}</td>
